...
// ============================================
// CREDENCIAIS — trocar por consulta ao banco
// ============================================
define('ADMIN_EMAIL', 'admin@saborecia.com');
define('ADMIN_SENHA', 'admin123'); // Em produção: usar password_hash()
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif ($senha !== ADMIN_SENHA) {
        // Em produção: password_verify($senha, $hash_do_banco)
        $erro = 'E-mail ou senha incorretos.';
    } else {
        // Login bem-sucedido
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .lado-esq::after {
            ...
            border-radius: 50%;
            background: radial-gradient(circle, rgba(244,63,122,.1) 0%, transparent 70%);
        ...
        .brand-badge {
            ...
            border: 1px solid rgba(244,63,122,.3);
            color: var(--rosa);
            font-size: .72rem;
            font-weight: 600;
            letter-spacing: 1px;
        ...
        .campo-input-wrap svg {
            position: absolute;
            left: 13px; top: 50%;
            transform: translateY(-50%);
            width: 15px; height: 15px;
            stroke: var(--cinza); fill: none; stroke-width: 2;
            pointer-events: none;
        }
        .campo input {
            width: 100%;
...
<div class="page">
    ...
    <div class="lado-esq">
        ...
        <div class="brand-content">
            ...
            <div class="brand-stats">
                <div class="brand-stat">
                    <div class="brand-stat-val">24</div>
                    <div class="brand-stat-lbl">Pedidos hoje</div>
                </div>
                <div class="brand-stat">
                    <div class="brand-stat-val">R$ 924</div>
                    <div class="brand-stat-lbl">Faturamento</div>
                </div>
                <div class="brand-stat">
                    <div class="brand-stat-val">4.9</div>
                    <div class="brand-stat-lbl">Avaliação</div>
                </div>
            </div>
        </div>
        ...
        <div class="brand-footer">
            ...
            <a href="../index.php">Ver site público</a>
        </div>
    </div>
    ...
    <div class="lado-dir">
        <div class="form-box">
                ...
                <div class="campo">
                    ...
                    <div class="campo-input-wrap">
                        ...
                        <input
                            ...
                            id="email"
                            name="email"
                            placeholder="admin@saborecia.com"
            ...
            <!-- Dica de acesso para desenvolvimento -->
            <div class="dica-acesso">
                <strong>Acesso de teste:</strong><br>
                E-mail: <code>admin@saborecia.com</code><br>
                Senha: <code>admin123</code><br>
                <span style="color:#f59e0b;font-size:.72rem;margin-top:4px;display:block;">Remover este bloco em produção.</span>
            </div>
